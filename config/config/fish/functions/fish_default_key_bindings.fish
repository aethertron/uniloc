function fish_default_key_bindings -d "Default keybindings for fish"
	# source: https://github.com/kergoth/fish-shell/blob/master/share/functions/fish_default_key_bindings.fish
